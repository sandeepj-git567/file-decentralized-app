  ...
  return (
    <div>
      ...
      <div className="animate-section">
        <h2 className="animate-heading">What is SmartDrop ?</h2>
        <p className="animate-para">
          SmartDrop is a decentralized file storage system that uses
          ...
          SmartDrop, data management becomes decentralized and transparent, a
      ...
      <div className="about">
        ...
        <p className="about-text">
          At SmartDrop, we believe that data ownership and privacy are
